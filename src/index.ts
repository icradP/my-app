...
Public
forked from Zibri/cloudflare-cors-anywhere
Code
Pull requests
Actions
Projects
...
@Hanpeng-Chen
Hanpeng-Chen update index.js
Latest commit e64ab6b on 21 Apr 2021
 History
 2 contributors
@Zibri@Hanpeng-Chen
162 lines (137 sloc)  6.11 KB
...
/*
whitelist = [ "^http.?://www.icrad.top$", "chenhanpeng.com$" ];  // regexp for whitelisted urls
*/

blacklist = [ ];           // regexp for blacklisted urls
// whitelist = [ ".*" ];     // regexp for whitelisted origins
whitelist = [ "^http.?://www.icrad.top$", "icrad.top$" ]
    ...
    event.respondWith((async function() {
        ...
        if ((!isListed(fetch_url, blacklist)) && (isListed(orig, whitelist))) {
            ...
            return new Response(
                ...
                "\nDonate</br>\n" +
                "<a href='https://www.icrad.top/create-own-cors-anywhere-to-resolve-the-request-with-403'>在cloudflare上创建一个免费的在线代理来解决gitalk授权登录报403问题</a>\n",
                {
                    status: 403,
